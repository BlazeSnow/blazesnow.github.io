  ...
  themeConfig: {
    ...
    sidebar: {
      '/changelog/': [
        ...
        { text: '2026年', link: '/changelog/2026' },
        { text: '2025年', link: '/changelog/2025' },
        { text: '2024年', link: '/changelog/2024' },
      ],
      '/windows/': [
        {
          text: '系统',
    ...
    //主页页脚
    footer: {
      message: '本网站以 <a href="https://www.gnu.org/licenses/agpl-3.0.html" target="_blank">GNU AGPL v3.0</a> 的条款发布。',
